...
var translate_en = {
  ...
  pay           : "Pay",
  submitting    : 'Sending transaction to XAG network',
  ...
  reset : 'Reset',
  remove : 'Remove',
  selected_net    : 'Selected Consensus Network',
  switch_net      : 'Switch Consensus Network',
  switch_net_desc : 'You can switch between different Consensus Network. The testnets are for, well, testing - they are also occasionally reset, so don’t get attached to any balances or accounts that you have on it.',
  public_net : 'Public Network',
  test_net   : 'Test Network',
  other_net  : 'User defined',
  'XAG Public Network' : 'XAG Public Network',
  ...
  disallowxrp : 'Indicates that client applications should not send XAG to this account. Not enforced by the network.',
  ...
  ripple : 'Ripple',
  web_client : 'XAG Smart Client',
  trade_volume : 'Trade Volume',
  wallet : 'Wallet',
  version: 'Version',
  logout : 'Logout',
  new_version_available: 'New version available',
  XAG_web_client: 'XAG Smart Client',
  server: 'The server',
  port: 'PORT',
  operation: 'OPERATION',
  /** Error **/
