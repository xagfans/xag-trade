...
var translate_cn = {
  ...
  create_new_account_info : '密钥将会存在你的本地文件里，并被密码保护。请您务必备份好账户文件。',
  ...
  convert_nopath: '没有合适的兑换路径。可能是账号的资金或授权不足。',
  receive       : '数量',
  calculating   : '计算中……',
  ...
  test_net   : '测试网络',
  other_net  : '自定义',
  'XAG Public Network' : '瑞波基因公网',
  'XAG Test Network' : '测试网络',
  'User defined' : '自定义',
  xag_url : 'XAG Public Network',
  test_url   : 'XAG Test Network',
  other_url  : '网络节点',
  passphrase : '网络标识',
  max_fee     : '最大费用',
  ...
  domain_done : '域名设置成功',
  payment_flag: '支付标志',
  disallowxrp : '对方转账时提示，该账号不接受原生资产XAG。注意：非强制性，对方仍可强行发送。',
  ...
  XAG_web_client: '瑞波基因全功能终端',
  server: '服务器',
  port: '端口',
  operation: '操作',
  addTo: '添加',
  /** Error **/
  NotFoundError : '共识网络未找到该账号，请先激活此账号。激活需要至少20 {{code}}。每个授权和委托单需要额外冻结5 {{code}}，建议用50 {{code}}完成激活。',
