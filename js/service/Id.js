...
myApp.factory('Id', function($window) {
  let _ripple = new ripple.RippleAPI();
  ...
  return {
    ...
    generateAccount : function(mnemonic) {
      ...
      if (mnemonic) {
        ...
        var hddata = ed25519.derivePath("m/44'/144'/0'", seedHex);
    ...
    fromSecret : function(secret) {
      ...
      return {address:  ripple.RippleAPI.deriveClassicAddress(keypair.publicKey), secret: secret};
    },
